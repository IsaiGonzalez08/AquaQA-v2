...
export function InitSection() {
    ...
    return (
        <div className="w-full flex flex-row items-center px-20">
            <div className="w-1/2 flex justify-start 2xl:justify-center">
                <div>
                    <h1 className="w-fit text-primary font-bold text-6xl leading-20">Agua limpia, <br /><span className="text-secondary">futuro brillante</span></h1>
                    <h3 className="w-fit text-foreground text-2xl font-medium mt-2">Invirtamos en calidad para un mundo radiante</h3>
                    <div className="w-fit flex gap-5 ml-4 mt-10">
                    ...
                    <div className="w-fit flex flex-row ml-4 mt-10">
            ...
            <div className="w-1/2 flex flex-row justify-start 2xl:justify-center gap-4 items-center relative">
                <div
